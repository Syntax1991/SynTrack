...
export class AddonCharacterPersistence {
  ...
  private readonly seasonEvidencePersistence =
    new AddonSeasonEvidencePersistence();
  ...
  private async persistCharacter(
    ...
    await this.weeklyActivityPersistence.persist(
      transaction,
      storedCharacter.id,
    ...
    await this.seasonEvidencePersistence.persist(
      transaction,
      storedCharacter.id,
      character.seasonEvidence,
      result
    );
